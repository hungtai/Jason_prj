...
<div id="mainbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3">
	<div class="panel panel-info" >
		...
		<div style="padding-top:50px;padding-bottom:50px" class="panel-body" align="center">
			<a id="btn-contract" class="btn btn-primary" data-toggle="modal">請點我閱讀註冊條款</a>
...
<script type="text/javascript" src="http://project.im.fju.edu.tw/public/js/front/register.js"></script></div>
